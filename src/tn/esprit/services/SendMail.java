...
public class SendMail {
    ...
    public void sendEmail(String to,int ticket) {
        ...
        try {
            ...
            message.setText("Félicitation votre reservation à été effecuter avec succées et votre numero de ticket est : "+ticket);
